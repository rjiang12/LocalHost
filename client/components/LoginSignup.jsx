...
const LoginSignup = props => {
    ...
    //function to run when button is clicked
        ...
        const loginBtn = async () => {
            try {
              const status = await axios.post('http://localhost:3000/login', 
              ...
              if (status) props.changeLoginState(true); // route to homepage
        ...
        const signUpBtn = async () => {
            try {
                ...
                const status = await axios.post('http://localhost:3000/signup',
